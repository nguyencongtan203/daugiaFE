...
const handleImage = (e) => {
  ...
  // 1️⃣ Loại bỏ dấu, 2️⃣ Chuyển khoảng trắng thành '-', 3️⃣ Chuyển thành lowercase
...
const submitProduct = async () => {
  ...
  try {
    ...
    // 2️⃣ Upload ảnh (Multipart + tên sanitize)
