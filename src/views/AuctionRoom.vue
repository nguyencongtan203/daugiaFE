    ...
    >
      ...
      <div class="relative">
        <button ref="cateBtn" class="category-btn" @click="toggleCate">
          ...
          <svg
            class="h-4 w-4 text-slate-500 ml-2"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          ...
          >
            ...
            <div class="px-5 pt-3 pb-5 flex-1 flex flex-col">
              ...
              <button
                class="mt-4 w-full text-white py-3 rounded-xl font-semibold inline-flex items-center justify-center gap-2 bg-[#127fcf] hover:bg-[#1992eb] btn-register"
